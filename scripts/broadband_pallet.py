...
class BroadbandPallet(Pallet):
    ...
    def post_copy_process(self):
        ...
        for cs in cachedServices:
            ...
            new_env.update({"PYTHONPATH": "C:\Python27\ArcGISx6410.6;C:\Python27\ArcGISx6410.6\lib"})
            result = subprocess.run([r'C:\Python27\ArcGISx6410.6\python.exe', join(current_folder, 'cache.py'),
